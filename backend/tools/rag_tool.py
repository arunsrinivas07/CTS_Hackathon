...
from schemas.tool import ToolOutput, ToolResultStatus, EvidenceItem, CMSEvidenceMetadata, LCDEvidenceMetadata, ContradictionDetail
from services.rag.retrieval_service import RetrievalService
from schemas.tool import ClaimContext  # or wherever ClaimContext is
    ...
    def run(self, *, query: str, procedure: str | None = None, diagnosis: str | None = None, claim_id: str | None = None, claim_amount: float | None = None, provider_id: str | None = None, **_) -> ToolOutput:
        ...
        try:
            ...
            return ToolOutput(
                ...
                citations=[e.dict() for e in evidence_items],
