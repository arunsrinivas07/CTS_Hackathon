...
from app.tools.ml.repository import BaseMLRepository, MockMLRepository, RealMLRepository
from ...schemas.tool import MLRiskResponse, MLScenarioResponse, ToolErrorResponse
from app.tools.utils.tool_helpers import format_tool_error, logger, timed
...
class ModelService:
    ...
    def __init__(self, repository: Optional[BaseMLRepository] = None) -> None:
        ...
        if repository is not None:
            ...
            from app.tools.ml.repository import LiveMLRepository
