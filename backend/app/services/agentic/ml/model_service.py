...
from app.services.agentic.ml.repository import BaseMLRepository, MockMLRepository, RealMLRepository
from app.schemas.agentic.tool import MLRiskResponse, MLScenarioResponse, ToolErrorResponse
...
class ModelService:
    ...
    def __init__(self, repository: Optional[BaseMLRepository] = None) -> None:
        ...
        if repository is not None:
            ...
            from app.services.agentic.ml.repository import LiveMLRepository
