...
def get_investigation_state_provider() -> InvestigationStateProvider:
    """FastAPI dependency factory. Swap the returned implementation here
    once the real orchestrator integration exists — this is the single
    place the rest of the app needs to change."""
    return MockInvestigationStateProvider()
