...
def build_inv_001() -> InvestigationState:
    return InvestigationState(
        ...
        detected_patterns=[
            "provider_frequency_anomaly",
            "amount_outlier_for_procedure_code",
        ],
        evidence=[
            Evidence(
                id="EV-1",
                summary="Provider MRI volume for the current month is 520 claims.",
                detail="ABC Hospital billed 520 MRI procedures in the current month, compared to a peer group "
                       "95th percentile of 310 per month.",
            ...
            Evidence(
                id="EV-2",
                summary="Claim amount is above the regional peer benchmark for this procedure code.",
                detail="The billed amount of $5,000 for this MRI procedure code is above the regional peer "
                       "median of $3,200.",
            ...
            Evidence(
                id="EV-3",
                summary="Diagnosis code on file is consistent with an MRI being a reasonable procedure.",
                detail="The patient's diagnosis code (M54.5 - low back pain) is a diagnosis for which MRI is a "
                       "commonly accepted diagnostic procedure under standard clinical guidelines.",
        ...
        counter_evidence=[
            CounterEvidence(
                id="CE-1",
                summary="Provider has a large registered patient base, which partially explains higher volume.",
                detail="ABC Hospital serves a larger regional patient population than most peer providers, which "
                       "may account for some of the elevated procedure volume.",
                source="Provider Registry",
            ),
            CounterEvidence(
                id="CE-2",
                summary="No prior fraud flags exist on this provider in the last 24 months.",
                detail="A review of the provider's compliance history shows no prior confirmed fraud findings in "
                       "the last 24 months.",
        ...
        final_report=FinalReport(
            summary="Claim shows a high risk score driven primarily by provider procedure frequency and claim "
