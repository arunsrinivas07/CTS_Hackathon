...
const systemMetrics = [
  ...
  { label: 'Failed Validations (24h)', value: '0', status: 'normal' },
  { label: 'API Response Time (avg)', value: '112ms', status: 'normal' },
  { label: 'System Uptime', value: '99.99%', status: 'normal' },
  { label: 'DB Query Avg', value: '18ms', status: 'normal' },
...
export default function SystemAlerts() {
  ...
  useEffect(() => {
    ...
    notificationsAPI.getAll()
      ...
      .catch(err => console.warn('Could not load notifications in SystemAlerts:', err));
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        {['all', 'critical', 'warning', 'info'].map(t => (
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors capitalize ${typeFilter === t ? 'bg-rose-600 text-white' : 'bg-white border border-slate-200 text-slate-600 hover:bg-slate-50'
              }`}
          >
